    ...
    <div className="mt-8">
      <div className="mb-8 p-6 shadow-md rounded-lg">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
              ...
              <button type="submit" className="px-4 py-2 bg-gray-700 hover:bg-gray-900 hover:cursor-pointer rounded-md text-white font-medium">Update Profile</button>
          </form>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {studyBuddies.map((buddy) => (
          <div key={buddy._id} className="block p-4 shadow-lg rounded-lg transition-colors">
